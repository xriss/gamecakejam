...
print(act,w.id)
	...
	function gui.pages.menu(master)
		...
		local top=master:add({hx=768,hy=512,class="fill",font="Vera",text_size=24})

		top:add({hx=768,hy=360})
		
		top:add({hx=40+64,hy=40})
		...
		top:add({hx=768,hy=20})

		top:add({hx=20+64,hy=40})
